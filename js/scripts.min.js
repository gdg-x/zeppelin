...
1E3)});$('#tickets').appear(function(){ga('send','event','Tickets','appear');}a(".animated").appear(function(){var b=a(this),d=b.data("animation"),c=b.data("delay");c?setTimeout(function(){b.addClass(d+" visible");b.removeClass("hiding");b.hasClass("counter")&&b.find(".timer").countTo()},c):(b.addClass(d+" visible"),b.removeClass("hiding"),b.hasClass("counter")&&b.find(".timer").countTo())},{accY:-150});equalheight=function(b){var d=0,c=0,e=[],f;a(b).each(function(){f=a(this);a(f).height("auto");topPostion=f.position().top;if(c!=topPostion){for(currentDiv=0;currentDiv<
